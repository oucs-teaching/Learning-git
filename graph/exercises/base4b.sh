...
# Stages and commits all changes to already-tracked files (i.e. the altered line above).
...
# UPDATE ON WRONG BRANCH

echo "Adding to the feature" > feature.txt

# Creates a new text file containing a single line.

git add -A

# Stages all changes (i.e. the new file above).
